...
`},{getState:Ce}=$,R=Ce().state,Fa=Ce().addReward,ke=Ce().deleteReward,Wa=(e,t)=>v`
<div class="quests-wrapper">
    <details>
...
`},za=["0.jpg","1.jpg","2.jpg","3.jpg","4.jpg","5.jpg","6.jpg","7.jpg","8.jpg","9.jpg","10.jpg","11.jpg","12.jpg","13.jpg","14.jpg","15.jpg","16.jpg","17.jpg","18.jpg"],{getState:de}=$,P=de().state,te=de().setCurrentView,ja=de().setAvatar,Ka=de().setName,Ua=()=>(setTimeout(()=>{const e=document.querySelector("#dialog-start-game");P.name===void 0&&!(e!=null&&e.hasAttribute("open"))&&(m.registerDialog(e),e.showModal())},50),v`
    <div class="game-wrapper">
        ...
        <dialog class="nes-dialog" id="dialog-start-game">
            ...
            <div>
                ${za.map(e=>v`
                            <img src=${"./characters/"+e} onclick=${()=>ja(e)} class=${e===P.image?"avatars selected":"avatars"} />
                        `)}
            </div>
            <menu class="dialog-menu">
                <button class="nes-btn is-primary" onclick=${()=>{const e=document.querySelector("#name_character_field");Ka(e.value)}} >Begin Quest!</button>
            </menu>
            </form>
        </dialog>
    </div>
